...
Regarding daylight savings time and different time zones some explicit choices had to be made. They are explained here, so the user knows what to expect when using the `padr` funcitons.
