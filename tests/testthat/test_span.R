...
test_that('shift_end_from_start gives correct output', {
  ...
  expect_equal(shift_end_from_start(gsae_year, as.Date('2016-02-01')),
               as.Date('2017-02-01'))
  expect_equal(shift_end_from_start(gsae_year, as.POSIXct('2016-02-01 00:04:01')),
               as.POSIXct('2017-02-01 00:04:01'))
  expect_equal(shift_end_from_start(gsae_week, as.Date('2015-12-25')),
               as.Date('2016-03-04'))
  expect_equal(shift_end_from_start(gsae_week, as.POSIXct('2015-12-25 00:04:01')),
               as.POSIXct('2016-03-04 00:04:01'))
})

context('assure_greater_than_max_x makes sure that end_val is greater than max_x')
