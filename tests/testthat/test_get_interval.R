...
test_that('datetime_char adds zeros to Date', {
  expect_equal(days %>% datetime_char, c('2016-01-01 00:00:00', '2016-02-29 00:00:00'))
})

test_that('datetime_char does not change POSIXt', {
  expect_equal(posix_ct %>% datetime_char, c('2016-01-01 21:19:53', '2016-02-29 10:16:11'))
  expect_equal(posix_lt %>% datetime_char, c('2016-01-01 21:19:53', '2016-02-29 10:16:11'))
})
...
test_that('lowest_differ return empty character whe x does not differ', {
  ...
  expect_equal( c('2016-01-01 00:00:00', '2016-01-01 00:00:00') %>% lowest_differ, character(0) )
})

test_that('get_interval breaks when x does not differ', {
  expect_error( '2016-01-01 00:00:00' %>% get_interval )
  expect_error( c('2016-01-01 00:00:00', '2016-01-01 00:00:00') %>% get_interval)
})

test_that('lowest_differ returns the correct interval', {
  expect_equal( c('2016-01-01 00:00:00', '2017-01-01 00:00:00') %>% lowest_differ, 'year')
  expect_equal( c('2016-01-01 00:00:00', '2017-02-01 00:00:00') %>% lowest_differ, 'month')
  expect_equal( c('2016-01-01 00:00:00', '2017-02-03 00:00:00') %>% lowest_differ, 'day')
  expect_equal( c('2016-01-01 00:00:00', '2017-02-03 12:00:00') %>% lowest_differ, 'hour')
  expect_equal( c('2016-01-01 00:00:00', '2017-02-03 12:51:00') %>% lowest_differ, 'min')
  expect_equal( c('2016-01-01 00:00:00', '2017-02-03 12:51:23') %>% lowest_differ, 'sec')
})
