...
test_that('round_down gives correct ouput', {
  ...
  expect_true(all(a_ct_down >= a_ct_down))
  expect_true(all(a_ct_cet_down >= a_ct_cet_down))
  expect_true(all(a_lt_down >= a_lt_down))
...
test_that('round_up gives correct ouput', {
  ...
  expect_true(all(a_ct_down < a_ct_up))
  expect_true(all(a_ct_cet_down < a_ct_cet_up))
  expect_true(all(a_lt_down < a_lt_up))
