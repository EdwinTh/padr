...
# More information
See the the general [introduction Vignette](https://CRAN.R-project.org/package=padr/vignettes/padr.html) for more examples. The [implementation details Vignette](https://CRAN.R-project.org/package=padr/vignettes/padr_implementation.html) describes how `padr` handles different time zones and daylight savings time.
